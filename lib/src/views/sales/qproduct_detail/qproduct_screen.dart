...
class QProductScreen extends StatefulWidget {
  ...
  const QProductScreen({super.key, required this.qproduct});
...
class _QProductScreenState extends State<QProductScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final detail = widget.qproduct.detail;
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Row(
          children: [BackWidget(), Text('Ver Producto', style: AppTextStyle.appBarStyle())],
        ),
      ),
      body: Column(
        children: [
                    ...
                    BlocBuilder<QProductDetailBloc, QProductDetailState>(
                      builder: (context, state) {
                        ...
                        if (state is QProductDetailLoad) {
                          for (var storage in state.detail.detail!.storages) {
                            ...
                            child: Column(
                              ...
                              children: [
                                Row(
                                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                  children: [
                                    Text('Stock', style: AppTextStyle.cls2Style(fontSize: 16)),
                                    Text(sum.toStringAsFixed(2), style: AppTextStyle.cls9Style(fontW: FontWeight.w700)),
                                  ],
                                ),
                                Expanded(
                                    child: Padding(
                                  ...
                                  child: ListView.builder(
                                    itemCount: detail!.storages.length,
                                    itemBuilder: (context, index) {
                                      final storage = detail.storages[index];
                                      String stock =
                                          storage.quantity <= 0 ? 'sin stock' : storage.quantity.toStringAsFixed(2);
                                      if (storage.branchId ==
                                          getIt<BranchesRepository>().branchSelected!.entity.branchId) {
                                        return Container(
                                          height: 26.h,
                                          ...
                                          child: Row(
                                            children: [
                                              ...
                                              Container(
                                                ...
                                                decoration: BoxDecoration(
                                                    color: AppColors.cls5, borderRadius: BorderRadius.circular(8)),

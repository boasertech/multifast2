...
class _FilterScreenState extends State<FilterScreen> {
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 20),
                  _buildFilterType(context, FilterType(1, 'Categorías', 'Todos', AppIcons.category)),
                  //_buildFilterType(context, FilterType(2, 'Sub Categoría', 'Todos', AppIcons.storages)),
                  //_buildFilterType(context, FilterType(3, 'Almacenes', 'Todos', AppIcons.subCategory)),
                ],
              ),
            ),
          ),
          Padding(
            ...
            child: Row(
              children: [
                ...
                SizedBox(width: 15),
                _buildBottom(context, 'Limpiar Filtros', isCancel: true),
              ],
            ),
          ),
          SizedBox(height: 20),
  ...
  Widget _buildFilterType(BuildContext context, FilterType filter) {
    return Padding(

...
class RegisterModal extends StatelessWidget {
  ...
  const RegisterModal({super.key, required this.title, required this.subTitle});
...
showRegisterModal(BuildContext context, String title, String subTitle) {
  showDialog(
    context: context,
    builder: (context) {
      return Dialog(
        backgroundColor: Colors.white,
        child: RegisterModal(title: title, subTitle: subTitle),
      );
    },
  );
}
